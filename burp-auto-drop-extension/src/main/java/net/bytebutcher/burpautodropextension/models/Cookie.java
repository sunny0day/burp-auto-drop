...
public class Cookie implements ICookie {
    ...
    public static Optional<Cookie> parseResponseCookie(String rawCookie) {
        ...
        if (cookieName.isEmpty()) {
            BurpExtender.getInstance().getCallbacks().printError("Invalid cookie: missing name");
            ...
            if ("secure".equalsIgnoreCase(paramName)) {
                ...
                if ("expires".equalsIgnoreCase(paramName)) {
                    try {
                        ...
                        BurpExtender.getInstance().getCallbacks().printError("WARNING: unable to parse cookie expiration: " + paramValue);
                    }
